...
def predict_using_user_strengths(row: RowForML, model: Dict[int, FootyStrength]) -> float:
    ...
    team1_strength = model[row.team1_defender_user_id].defensive_strength + model[row.team1_attacker_user_id].attack_strength
    team2_strength = model[row.team2_defender_user_id].defensive_strength - model[row.team2_attacker_user_id].attack_strength
